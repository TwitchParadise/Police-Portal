            ...
            if(filter_var($mail, FILTER_VALIDATE_EMAIL)) {
               ...
               if($mailexist == 0) {
                  if($mdp == $mdp2) {
                     ...
                     $erreur = "your account has been created ! <a href=\"login.php\">Me connecter</a>";
                  } else {
               ...
               $erreur = "Your email adress is invalid !";
            }
         } else {
            $erreur = "password dot not match !";
         }
      } else {
         $erreur = "nickname can be a maximum of 255 characters. !";
      }
   } else {
